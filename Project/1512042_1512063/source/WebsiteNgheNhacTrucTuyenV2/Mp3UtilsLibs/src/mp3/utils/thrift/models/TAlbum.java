...
public class TAlbum implements org.apache.thrift.TBase<TAlbum, TAlbum._Fields>, java.io.Serializable, Cloneable, Comparable<TAlbum> {
  ...
  public TAlbum setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TAlbum setSongs(List<mp3.utils.thrift.models.TReferencer> songs) {
    this.songs = songs;
    return this;
  }
  ...
  public TAlbum setImage(String image) {
    this.image = image;
    return this;
  }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAlbum struct) throws org.apache.thrift.TException {
      ...
      if (struct.songs != null) {
        oprot.writeFieldBegin(SONGS_FIELD_DESC);
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter3 : struct.songs)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSongs()) {
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter4 : struct.songs)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.songs = new ArrayList<mp3.utils.thrift.models.TReferencer>(_list5.size);
          mp3.utils.thrift.models.TReferencer _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new mp3.utils.thrift.models.TReferencer();
            _elem6.read(iprot);
