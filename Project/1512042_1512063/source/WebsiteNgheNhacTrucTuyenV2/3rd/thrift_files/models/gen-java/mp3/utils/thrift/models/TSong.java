...
public class TSong implements org.apache.thrift.TBase<TSong, TSong._Fields>, java.io.Serializable, Cloneable, Comparable<TSong> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSong");
  ...
  static {
    schemes.put(StandardScheme.class, new TSongStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSongTupleSchemeFactory());
  }

  public String id; // required
  public String name; // required
  public mp3.utils.thrift.models.TReferencer album; // required
  ...
  public List<mp3.utils.thrift.models.TReferencer> kinds; // required
  public List<mp3.utils.thrift.models.TReferencer> singers; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSong.class, metaDataMap);
  }
  ...
  public TSong(
    String id,
    String name,
    mp3.utils.thrift.models.TReferencer album,
    String lyrics,
    List<String> composers,
    String kara,
    short duration,
    List<mp3.utils.thrift.models.TReferencer> kinds,
    List<mp3.utils.thrift.models.TReferencer> singers,
    long views,
    String comment,
    String image)
  {
  ...
  public TSong(TSong other) {
    ...
    if (other.isSetAlbum()) {
      this.album = new mp3.utils.thrift.models.TReferencer(other.album);
    }
    ...
    if (other.isSetKinds()) {
      List<mp3.utils.thrift.models.TReferencer> __this__kinds = new ArrayList<mp3.utils.thrift.models.TReferencer>(other.kinds.size());
      for (mp3.utils.thrift.models.TReferencer other_element : other.kinds) {
        __this__kinds.add(new mp3.utils.thrift.models.TReferencer(other_element));
      }
      this.kinds = __this__kinds;
    }
    if (other.isSetSingers()) {
      List<mp3.utils.thrift.models.TReferencer> __this__singers = new ArrayList<mp3.utils.thrift.models.TReferencer>(other.singers.size());
      for (mp3.utils.thrift.models.TReferencer other_element : other.singers) {
        __this__singers.add(new mp3.utils.thrift.models.TReferencer(other_element));
      }
  ...
  public TSong deepCopy() {
    return new TSong(this);
  }
  ...
  public TSong setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public mp3.utils.thrift.models.TReferencer getAlbum() {
    return this.album;
  }

  public TSong setAlbum(mp3.utils.thrift.models.TReferencer album) {
    this.album = album;
    return this;
  }
  ...
  public TSong setLyrics(String lyrics) {
    this.lyrics = lyrics;
    return this;
  }
  ...
  public TSong setComposers(List<String> composers) {
    this.composers = composers;
    return this;
  }
  ...
  public TSong setKara(String kara) {
    this.kara = kara;
    return this;
  }
  ...
  public TSong setDuration(short duration) {
    this.duration = duration;
    setDurationIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<mp3.utils.thrift.models.TReferencer> getKindsIterator() {
    return (this.kinds == null) ? null : this.kinds.iterator();
  }

  public void addToKinds(mp3.utils.thrift.models.TReferencer elem) {
    if (this.kinds == null) {
      this.kinds = new ArrayList<mp3.utils.thrift.models.TReferencer>();
    }
    this.kinds.add(elem);
  }

  public List<mp3.utils.thrift.models.TReferencer> getKinds() {
    return this.kinds;
  }

  public TSong setKinds(List<mp3.utils.thrift.models.TReferencer> kinds) {
    this.kinds = kinds;
    return this;
  }
  ...
  public java.util.Iterator<mp3.utils.thrift.models.TReferencer> getSingersIterator() {
    return (this.singers == null) ? null : this.singers.iterator();
  }

  public void addToSingers(mp3.utils.thrift.models.TReferencer elem) {
    if (this.singers == null) {
      this.singers = new ArrayList<mp3.utils.thrift.models.TReferencer>();
    }
    this.singers.add(elem);
  }

  public List<mp3.utils.thrift.models.TReferencer> getSingers() {
    return this.singers;
  }

  public TSong setSingers(List<mp3.utils.thrift.models.TReferencer> singers) {
    this.singers = singers;
    return this;
  }
  ...
  public TSong setViews(long views) {
    this.views = views;
    setViewsIsSet(true);
    return this;
  }
  ...
  public TSong setComment(String comment) {
    this.comment = comment;
    return this;
  }
  ...
  public TSong setImage(String image) {
    this.image = image;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ALBUM:
      if (value == null) {
        ...
        setAlbum((mp3.utils.thrift.models.TReferencer)value);
      }
      break;
    ...
    case KINDS:
      if (value == null) {
        ...
        setKinds((List<mp3.utils.thrift.models.TReferencer>)value);
      }
      break;
    ...
    case SINGERS:
      if (value == null) {
        ...
        setSingers((List<mp3.utils.thrift.models.TReferencer>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TSong)
      return this.equals((TSong)that);
    return false;
  }

  public boolean equals(TSong that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TSong other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSong(");
    boolean first = true;
  ...
  private static class TSongStandardSchemeFactory implements SchemeFactory {
    public TSongStandardScheme getScheme() {
      return new TSongStandardScheme();
    }
  }

  private static class TSongStandardScheme extends StandardScheme<TSong> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSong struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 3: // ALBUM
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.album = new mp3.utils.thrift.models.TReferencer();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.kinds = new ArrayList<mp3.utils.thrift.models.TReferencer>(_list3.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.singers = new ArrayList<mp3.utils.thrift.models.TReferencer>(_list6.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSong struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.kinds != null) {
        oprot.writeFieldBegin(KINDS_FIELD_DESC);
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter10 : struct.kinds)
          {
            _iter10.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.singers != null) {
        oprot.writeFieldBegin(SINGERS_FIELD_DESC);
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter11 : struct.singers)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TSongTupleSchemeFactory implements SchemeFactory {
    public TSongTupleScheme getScheme() {
      return new TSongTupleScheme();
    }
  }

  private static class TSongTupleScheme extends TupleScheme<TSong> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSong struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKinds()) {
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter13 : struct.kinds)
          {
            _iter13.write(oprot);
          }
        }
      ...
      if (struct.isSetSingers()) {
        {
          ...
          for (mp3.utils.thrift.models.TReferencer _iter14 : struct.singers)
          {
            _iter14.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSong struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.kinds = new ArrayList<mp3.utils.thrift.models.TReferencer>(_list18.size);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.singers = new ArrayList<mp3.utils.thrift.models.TReferencer>(_list21.size);
