...
public class TSingerHandler implements TSingerServices.Iface{
    ...
    public boolean putSinger(TSinger singer) throws TException {
        return TSingerModel.Instance.putSinger(singer);
    }
    ...
    @Override
    public boolean putMultiSingers(List<TSinger> singers) throws TException {
        return TSingerModel.Instance.putMultiSingers(singers);
    }
