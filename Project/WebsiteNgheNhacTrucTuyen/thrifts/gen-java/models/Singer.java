...
public class Singer implements org.apache.thrift.TBase<Singer, Singer._Fields>, java.io.Serializable, Cloneable, Comparable<Singer> {
  ...
  static {
    schemes.put(StandardScheme.class, new SingerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SingerTupleSchemeFactory());
  }
  ...
  public List<models.Referencer> albums; // required
  public List<models.Referencer> videos; // required
  ...
  public Singer(
    ...
    List<models.Referencer> albums,
    List<models.Referencer> videos,
    String imgCover,
    String imgAvatar)
  {
    this();
  ...
  public Singer(Singer other) {
    ...
    if (other.isSetAlbums()) {
      List<models.Referencer> __this__albums = new ArrayList<models.Referencer>(other.albums.size());
    ...
    if (other.isSetVideos()) {
      List<models.Referencer> __this__videos = new ArrayList<models.Referencer>(other.videos.size());
  ...
  public Singer setRealname(String realname) {
    this.realname = realname;
    return this;
  }
  ...
  public Singer setDob(String dob) {
    this.dob = dob;
    return this;
  }
  ...
  public Singer setCountry(String country) {
    this.country = country;
    return this;
  }
  ...
  public Singer setDescription(String description) {
    this.description = description;
    return this;
  }
  ...
  public Singer setSongs(List<models.Referencer> songs) {
    this.songs = songs;
    return this;
  }
  ...
  public void addToAlbums(models.Referencer elem) {
    if (this.albums == null) {
      this.albums = new ArrayList<models.Referencer>();
    }
    this.albums.add(elem);
  }

  public List<models.Referencer> getAlbums() {
    return this.albums;
  }

  public Singer setAlbums(List<models.Referencer> albums) {
    this.albums = albums;
    return this;
  }
  ...
  public void addToVideos(models.Referencer elem) {
    if (this.videos == null) {
      this.videos = new ArrayList<models.Referencer>();
    }
    this.videos.add(elem);
  }

  public List<models.Referencer> getVideos() {
    return this.videos;
  }

  public Singer setVideos(List<models.Referencer> videos) {
    this.videos = videos;
    return this;
  }
  ...
  public Singer setImgCover(String imgCover) {
    this.imgCover = imgCover;
    return this;
  }
  ...
  public Singer setImgAvatar(String imgAvatar) {
    this.imgAvatar = imgAvatar;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ALBUMS:
      if (value == null) {
        ...
        setAlbums((List<models.Referencer>)value);
      }
      break;
    ...
    case VIDEOS:
      if (value == null) {
        ...
        setVideos((List<models.Referencer>)value);
      }
      break;
  ...
  private static class SingerStandardSchemeFactory implements SchemeFactory {
    public SingerStandardScheme getScheme() {
      return new SingerStandardScheme();
    }
  }

  private static class SingerStandardScheme extends StandardScheme<Singer> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.albums = new ArrayList<models.Referencer>(_list3.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.videos = new ArrayList<models.Referencer>(_list6.size);
  ...
  private static class SingerTupleSchemeFactory implements SchemeFactory {
    public SingerTupleScheme getScheme() {
      return new SingerTupleScheme();
    }
  }

  private static class SingerTupleScheme extends TupleScheme<Singer> {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.songs = new ArrayList<models.Referencer>(_list15.size);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.albums = new ArrayList<models.Referencer>(_list18.size);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.videos = new ArrayList<models.Referencer>(_list21.size);
